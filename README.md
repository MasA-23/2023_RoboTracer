...
## 6.制御方法
 　以前は、ラインセンサの値を2値化して制御していましたが、より滑らかな走行にするためにPD制御を導入しました。PD制御を行うには，アナログ値を使用する必要があります．しかし，センサの値には個体差によるノイズ等が乗るため，値の校正が必要です．校正前のアナログ値を以下に示します．
...
<div align="center">
  <table><tr><td>
$x_{t}=x_{t-1}+\Delta lsin\theta _{t}$
